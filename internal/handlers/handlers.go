...
func (h *Handler) GetDashboard(c *gin.Context) { data, err := h.repo.Dashboard(); respond(c, data, err) }
func (h *Handler) GetStudentCourses(c *gin.Context) { data, err := h.repo.StudentCourses(); respond(c, data, err) }
func (h *Handler) GetAssignments(c *gin.Context) { data, err := h.repo.Assignments(); respond(c, data, err) }
func (h *Handler) GetGrades(c *gin.Context) { data, err := h.repo.Grades(); respond(c, data, err) }
func (h *Handler) GetAdminCourses(c *gin.Context) { data, err := h.repo.AdminCourses(); respond(c, data, err) }
func (h *Handler) GetAcademicYears(c *gin.Context) { data, err := h.repo.AcademicYears(); respond(c, data, err) }
...
func (h *Handler) DeleteCourse(c *gin.Context) { id,err := pathID(c); if err != nil { return }; err = h.repo.DeleteCourse(id); respond(c,gin.H{"id":id},err) }

func (h *Handler) CreateAcademicYear(c *gin.Context) { var payload models.AcademicYear; if bind(c,&payload){ return }; err := h.repo.CreateAcademicYear(&payload); created(c,payload,err) }
func (h *Handler) UpdateAcademicYear(c *gin.Context) { id,err := pathID(c); if err != nil { return }; var payload models.AcademicYear; if bind(c,&payload){ return }; err = h.repo.UpdateAcademicYear(id,&payload); respond(c,payload,err) }
func (h *Handler) DeleteAcademicYear(c *gin.Context) { id,err := pathID(c); if err != nil { return }; err = h.repo.DeleteAcademicYear(id); respond(c,gin.H{"id":id},err) }

func (h *Handler) CreateStudent(c *gin.Context) { var payload models.Student; if bind(c,&payload){ return }; err := h.repo.CreateStudent(&payload); created(c,payload,err) }
func (h *Handler) UpdateStudent(c *gin.Context) { id,err := pathID(c); if err != nil { return }; var payload models.Student; if bind(c,&payload){ return }; err = h.repo.UpdateStudent(id,&payload); respond(c,payload,err) }
func (h *Handler) DeleteStudent(c *gin.Context) { id,err := pathID(c); if err != nil { return }; err = h.repo.DeleteStudent(id); respond(c,gin.H{"id":id},err) }
func (h *Handler) ResetStudentPassword(c *gin.Context) { id,err := pathID(c); if err != nil { return }; data,err := h.repo.ResetStudentPassword(id); respond(c,data,err) }

func (h *Handler) CreateLecturer(c *gin.Context) { var payload models.Lecturer; if bind(c,&payload){ return }; err := h.repo.CreateLecturer(&payload); created(c,payload,err) }
func (h *Handler) UpdateLecturer(c *gin.Context) { id,err := pathID(c); if err != nil { return }; var payload models.Lecturer; if bind(c,&payload){ return }; err = h.repo.UpdateLecturer(id,&payload); respond(c,payload,err) }
func (h *Handler) DeleteLecturer(c *gin.Context) { id,err := pathID(c); if err != nil { return }; err = h.repo.DeleteLecturer(id); respond(c,gin.H{"id":id},err) }
func (h *Handler) ResetLecturerPassword(c *gin.Context) { id,err := pathID(c); if err != nil { return }; data,err := h.repo.ResetLecturerPassword(id); respond(c,data,err) }

func (h *Handler) CreateAssistant(c *gin.Context) { var payload models.LabAssistant; if bind(c,&payload){ return }; err := h.repo.CreateAssistant(&payload); created(c,payload,err) }
func (h *Handler) UpdateAssistant(c *gin.Context) { id,err := pathID(c); if err != nil { return }; var payload models.LabAssistant; if bind(c,&payload){ return }; err = h.repo.UpdateAssistant(id,&payload); respond(c,payload,err) }
func (h *Handler) DeleteAssistant(c *gin.Context) { id,err := pathID(c); if err != nil { return }; err = h.repo.DeleteAssistant(id); respond(c,gin.H{"id":id},err) }
func (h *Handler) ResetAssistantPassword(c *gin.Context) { id,err := pathID(c); if err != nil { return }; data,err := h.repo.ResetAssistantPassword(id); respond(c,data,err) }
...
func respond(c *gin.Context, data interface{}, err error) { if err != nil { fail(c,http.StatusInternalServerError,err.Error()); return }; ok(c,"success",data) }
func created(c *gin.Context, data interface{}, err error) { if err != nil { fail(c,http.StatusInternalServerError,err.Error()); return }; c.JSON(http.StatusCreated, models.APIResponse{Success:true,Message:"created",Data:data}) }
func ok(c *gin.Context, msg string, data interface{}) { c.JSON(http.StatusOK, models.APIResponse{Success:true,Message:msg,Data:data}) }
func fail(c *gin.Context, status int, message string) { c.JSON(status, models.APIResponse{Success:false,Error:message}) }

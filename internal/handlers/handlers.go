...
func Register(r *gin.Engine, h *Handler) {
	...
	api := r.Group("/api")
	{
		...
		api.GET("/admin/students/import/template", h.DownloadStudentImportTemplate)
		api.POST("/admin/students/import/preview", h.PreviewStudentImport)
		api.POST("/admin/students/import", h.ImportStudents)
		...
		api.GET("/admin/lecturers/import/template", h.DownloadLecturerImportTemplate)
		api.POST("/admin/lecturers/import/preview", h.PreviewLecturerImport)
		api.POST("/admin/lecturers/import", h.ImportLecturers)
		...
		api.GET("/admin/lab-assistants/import/template", h.DownloadAssistantImportTemplate)
		api.POST("/admin/lab-assistants/import/preview", h.PreviewAssistantImport)
		api.POST("/admin/lab-assistants/import", h.ImportAssistants)

...
func Register(r *gin.Engine, h *Handler) {
	...
	api := r.Group("/api")
	{
		...
		api.POST("/lecturer/courses", requireRole("admin", "aslab"), h.CreateLecturerCourse)
		api.PUT("/lecturer/courses/:id", requireRole("admin", "aslab", "kalab"), h.UpdateLecturerCourse)
		api.DELETE("/lecturer/courses/:id", requireRole("admin"), h.DeleteLecturerCourse)
		api.DELETE("/assistant/materials/:id", requireRole("aslab"), h.DeleteMaterial)
		api.GET("/materials", requireRole("admin", "kalab", "aslab"), h.GetMaterials)
		...
		api.PUT("/materials/:id/approve", requireRole("admin", "kalab"), h.ApproveMaterial)
		api.PUT("/materials/:id/reject", requireRole("admin", "kalab"), h.RejectMaterial)
		api.GET("/materials/:id/file", requireRole("admin", "kalab", "aslab", "student"), h.MaterialFile)
		api.GET("/materials/:id/download", requireRole("admin", "kalab", "aslab", "student"), h.DownloadMaterial)

		api.GET("/admin/courses", requireRole("admin", "kalab"), h.GetAdminCourses)
		api.POST("/admin/courses", requireRole("admin"), h.CreateCourse)
		api.PUT("/admin/courses/:id", requireRole("admin", "kalab"), h.UpdateCourse)
		api.DELETE("/admin/courses/:id", requireRole("admin"), h.DeleteCourse)

		api.GET("/admin/academic-years", requireRole("admin", "kalab"), h.GetAcademicYears)
		...
		api.GET("/admin/students", requireRole("admin"), h.GetStudents)
		...
		api.GET("/admin/classes", requireRole("admin"), h.GetClasses)
		api.POST("/admin/classes", requireRole("admin"), h.CreateClass)
		api.PUT("/admin/classes/:id", requireRole("admin"), h.UpdateClass)
		api.DELETE("/admin/classes/:id", requireRole("admin"), h.DeleteClass)
		...
		api.PUT("/assistant/reports/:id/review", requireRole("admin", "kalab"), h.ReviewAssistantReport)
		api.GET("/reports", requireRole("admin", "kalab", "aslab"), h.GetReports)
		api.GET("/reports/:id/file", requireRole("admin", "kalab", "aslab"), h.ReportFile)
		api.GET("/reports/:id/html", requireRole("admin", "kalab", "aslab"), h.ReportHTML)
		api.GET("/submissions/:id/download", requireRole("admin", "kalab", "aslab"), h.ReportFile)
		api.PUT("/reports/:id/approve", requireRole("admin", "kalab"), h.ApproveReport)
		api.PUT("/reports/:id/reject", requireRole("admin", "kalab"), h.RejectReport)
		...
		api.GET("/sessions/:id/ngain", requireRole("admin", "kalab", "aslab"), h.GetSessionNGain)
		api.GET("/courses/:id/ngain", requireRole("admin", "kalab", "aslab"), h.GetCourseNGain)
		...
		api.GET("/reports/workflow", requireRole("aslab", "admin", "kalab"), h.GetReportWorkflow)
		api.POST("/reports/workflow/submit", requireRole("aslab"), h.SubmitReportWorkflow)
		api.POST("/reports/workflow/approve", requireRole("admin", "kalab"), h.ApproveReportWorkflow)
		api.POST("/reports/workflow/reject", requireRole("admin", "kalab"), h.RejectReportWorkflow)
		api.POST("/reports/workflow/reset", requireRole("aslab"), h.ResetReportWorkflow)
		api.PUT("/assistant/submissions/:id/grade", requireRole("aslab", "admin"), h.GradeStudentSubmission)
		...
		api.GET("/assistant/assignments/:id/submissions", requireRole("aslab", "admin", "kalab"), h.GetAssignmentSubmissions)
		...
		api.POST("/upload", requireRole("admin", "kalab", "aslab", "student"), h.UploadFile)
		api.POST("/files/upload", requireRole("admin", "kalab", "aslab", "student"), h.UploadFile)
		api.GET("/files/*filepath", requireRole("admin", "kalab", "aslab", "student"), h.ServeFile)
		api.GET("/admin/courses/:id/sessions", requireRole("admin", "kalab"), h.GetCourseSessions)
		api.PUT("/admin/sessions/:id", requireRole("admin", "kalab"), h.UpdateCourseSession)
		api.DELETE("/admin/sessions/:id", requireRole("admin", "kalab"), h.DeleteCourseSession)
		api.GET("/admin/reports/export", requireRole("admin", "kalab"), h.ExportReportsXLSX)
		api.GET("/assignments/:id/trace", requireRole("admin", "kalab", "aslab"), h.GetAssignmentTraceFlow)
		api.GET("/assignments/:id/stats", requireRole("admin", "kalab", "aslab"), h.GetAssignmentStats)
		api.GET("/assignments/:id/grade-impact", requireRole("admin", "kalab", "aslab"), h.GetAssignmentGradeImpact)
		api.GET("/reports/:id/trace", requireRole("admin", "kalab", "aslab"), h.GetReportTraceFlow)
		api.GET("/submissions/:id", requireRole("admin", "kalab", "aslab", "student"), h.GetSubmissionDetail)
	}
}
...
func (h *Handler) GetDashboard(c *gin.Context) {
	...
	data, err := h.repo.Dashboard(authUser.ID)
	respond(c, data, err)
}
func (h *Handler) GetStudentCourses(c *gin.Context) {
	authUser, _ := currentAuthUser(c)
	data, err := h.repo.StudentCourses(authUser.ID)
	respond(c, data, err)
}
...
func (h *Handler) DeleteCourseSession(c *gin.Context) {
	...
	respond(c, gin.H{"id": id}, h.repo.DeleteCourseSession(id))
}
